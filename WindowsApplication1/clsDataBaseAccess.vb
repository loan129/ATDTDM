...
Public Class DataBaseAccess
    ...
    Private connectionstring As String = "workstation id=chuongtrinhVB3.mssql.somee.com;packet size=4096;user id=truyenshani_SQLLogin_1;pwd=abc123456789;data source=chuongtrinhVB3.mssql.somee.com;persist security info=False;initial catalog=chuongtrinhVB3"
