...
Public Class frmsanpham
    ...
    Private Function themsp() As Boolean
        Dim lenhsql As String = "INSERT INTO SANPHAM(masp, tensp, gia, maloai)"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim sqlquery As String = String.Format("select masp as 'Mã sản phẩm', tensp as 'Tên sản phẩm', maloai as 'Mã Loại', gia as 'Gía Tiền' from SANPHAM ")
    ...
    Private Sub btnedit_Click(sender As Object, e As EventArgs) Handles btnedit.Click
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim updatequery As String = "update SANPHAM set masp=@MASP, tensp=@TENSP, gia=@GIA, maloai=@MALOAI where MASP=@MASP"
