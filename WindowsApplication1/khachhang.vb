...
Public Class frmkhachhang
    ...
    Private Function themsp() As Boolean
        Dim lenhsql As String = "INSERT INTO KHACHHANG(makh, hoten, diachi, sodt)"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnhienthi.Click
        Dim sqlquery As String = String.Format("select makh as 'Mã khách hàng',hoten as 'Tên khách hàng', diachi as 'Địa chỉ', sodt as 'Số điện thoại' from KHACHHANG")
    ...
    Private Sub btnedit_Click(sender As Object, e As EventArgs) Handles btnedit.Click
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim updatequery As String = "update KHACHHANG set makh=@MAKH, hoten=@TENKH, diachi=@DIACHI, sodt=@SODT where makh=@MAKH"
